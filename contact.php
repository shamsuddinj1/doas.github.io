...
<h3>Email Here</h3>
<p><a href="alishaista368@gamil.com"><span class="__cf_email__" data-cfemail="123456">[email&#160;protected]</span></a></p>
<p><a href="alishaista368@gmail.com"><span class="__cf_email__" data-cfemail="123456">[email&#160;protected]</span></a></p>
</div>
</div>
<div class="col-lg-4 col-md-6 col-sm-6">
<div class="contact-info-box">
...
<h3>Call Here</h3>
<p><a href="tel:+92-(123)-456">+92-(123)-456</a></p>
<p><a href="tel:+92-(123)-456">+92-(123)-456</a></p>
</div>
</div>
</div>
...
<p><b>Send us Message for regarding any query immediately.</b></p>
</div>
...
<div class="col-lg-12 col-md-12">
<button type="submit" class="default-btn" name="btn-contact">
Send Message
<span></span>
</button>
...
<?php 
    if(isset($_POST['btn-contact'])){
        ...
        $insert = mysqli_query($con,"INSERT INTO contact_us(name,email,phone_number,msg_subject,message)VALUES('$name','$email','$phone_number','$msg_subject','$message')");
        if ($insert) {
                echo "<script>
                        swal({
                          title: 'Good job!',
                    ...
                    echo "<script>
                        swal({
                          title: 'Sorry!',
                          text: 'An Error Occured while submitting message!',
                          icon: 'error',
                        }).then(function() {
                            window.location = 'contact.php';
                        });
