...
<div class="col-lg-12">
<div class="send-btn">
<!-- <a class="default-btn" name="btnsignup">
Sign Up Now
<span></span>
</a> -->
<input type="submit" name="btnsignup" class="default-btn" value="Sign Up Now">
</div>
<br>
<span>Already a registered user? <a href="sign-in.php">Login!</a></span>
</div>
</div>
</form>
</div>
...
<h3>Tinzer</h3>
<p>Make A Appointment Easily At Home.</p>
...
<?php
    if (isset($_POST['btnsignup'])) {
        ...
        $insert = mysqli_query($con,"INSERT INTO registration(username,email,password) VALUES('$username','$email','$password')");
        if ($insert) {
             echo "<script>
                        swal({
                          title: 'Good job!',
